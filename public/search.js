...
const createBtn = document.getElementById("create-new-list");
if (createBtn) {
  createBtn.addEventListener("click", function (event) {
    document
      .getElementById("create-new-list")
    ...
    $.get("/user/watchlists", function (data) {
      ...
      data.forEach(function (watchlist) {
        ...
        var listItem = $("<li>").append(
          $("<a>")
            .attr("href", "#")
            .attr("id", "collection-" + cID)
            .addClass("dropdown-item")
            .text(watchlist.collection_name)
        );
